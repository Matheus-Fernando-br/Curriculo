...
function Contato() {
  ...
  const t = {
    pt: {
      ...
      msgTitle: "Estou sempre aberto a discutir novos projetos, ideias criativas ou oportunidades para fazer parte de sua visão.",
      InfoContact: "Informações de Contato",
      InfoMsg: "Entre em contato comigo através de um dos meios abaixo ou do formulário ao lado.",
    ...
    en: {
      ...
      msgTitle: "I am always open to discussing new projects, creative ideas, or opportunities to be part of your vision.",
      InfoContact: "Contact Information",
      InfoMsg: "Get in touch with me through one of the means below or the form beside.",
      ...
      <section className="contact-container">
        ...
        <div className="contact-right">
          ...
          <form
            ...
            encType="text/plain"
          >
            <label htmlFor="Nome">{t[lang].formName}</label>
            <input type="text" name="Nome" placeholder={t[lang].inputPlaceholderName} required />
            <label htmlFor="Email">{t[lang].formEmail}</label>
            <input type="email" name="Email" placeholder={t[lang].inputPlaceholderEmail} required />
            <label htmlFor="Assunto">{t[lang].formSubject}</label>
            <input type="text" name="Assunto" placeholder={t[lang].inputPlaceholderSubject} required />
